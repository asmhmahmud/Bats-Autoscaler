...
namespace AutoScaler.AutoScale
{
    class OurAlg
    {
        ...
        public OurAlg(WorkloadGen workloadGen, RuntimeDelay runtimeDelay)
        {
        ...
        public void executeExperiment(double v, double totalBudget, Boolean budUnaware, DataManager dataManager, Scaler scaler)
        {
            ...
            dataManager.addLog(DateTime.Now, budget_queue[current_t + 1], current_t, 0, predicted_workload, optimal_instances, v, budDeficit );
