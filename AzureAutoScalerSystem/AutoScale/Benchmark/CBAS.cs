...
namespace AutoScaler.Benchmark
{
    class CBAS
    {
        ...
        private void initData()
        {
            ...
            String outputFilePath = "CBAS_Result_" + currTime + ".csv";
            String IntermediateOutputFilePath = "CBAS_Inter_Result_" + currTime + ".csv";
        ...
        public void StartAutoScaling()
        {
                ...
                ourAlg.executeExperiment(v, SimulationSettings.budget, false, dataManager, scaler);
