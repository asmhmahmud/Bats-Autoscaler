 ...
 */
public class BATSESmallExp extends Experiment
{

        @Override
        protected void initalizeAlgorithm(ExpParams expParams)
        {
                BATS algorithm = new BATS("BATS_ES");
                ...
                algorithm.setVmType(VMType.EXTRA_SMALL);
        ...
        {
                Experiment exp = new BATSESmallExp("Experiment");
        ...
        public BATSESmallExp(String name)
        {
                super(name);
        }
