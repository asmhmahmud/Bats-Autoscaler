...
import azuresimulator.algorithms.BATSHV;
 ...
 */
public class BATSHVExperiment extends Experiment
{

        @Override
        protected void initalizeAlgorithm(ExpParams expParams)
        {
                BATSHV algorithm = new BATSHV("BATSHV");
        ...
        {
                Experiment exp = new BATSHVExperiment("Experiment");
        ...
        public BATSHVExperiment(String name)
        {
                super(name);
        }
