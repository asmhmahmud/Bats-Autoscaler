 ...
 */
public class ZtAvgEvenExp extends Experiment
{

        @Override
        protected void initalizeAlgorithm(ExpParams expParams)
        {
                ZtAvgEven algorithm = new ZtAvgEven("ZtAvgEven");
        ...
        {
                Experiment exp = new ZtAvgEvenExp("Experiment");
        ...
        public ZtAvgEvenExp(String name)
        {
                super(name);
        }
