 ...
 * @author Hasan
 */
public class RubisSingleVMTypeDelay_orig
{
...
//                {
//                        for (int i = 0; i < runTimeDelay.length; i++)
//                        {
//                                predictedValues[i] = false;
//                                initialized[i] = false;
//                        }
//                }
//                public void setProperty(ArrayList<TableCell> tblCells)
//                {
//                        predictedValues = new boolean[tblCells.size()];
//                        initialized = new boolean[tblCells.size()];
//                        runTimeDelay = new double[tblCells.size()][2];
//
//                        for (int i = 0; i < tblCells.size(); i++)
//                        {
//                                TableCell tblCell = tblCells.get(i);
//                                predictedValues[i] = tblCells.get(i).predictedValue;
//                                initialized[i] = tblCells.get(i).isInitialized;
//                                runTimeDelay[i][0] = tblCell.loadFactor;
//                                runTimeDelay[i][1] = tblCell.avgDelay;
//
//                        }
//                }
        }
        ...
        public RubisSingleVMTypeDelay_orig(String fileName)
        {
                //super(name);
